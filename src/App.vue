          ...
          <div class="cart_items">
            <div class="items d-flex justify-content-between align-items-center">
              <div class="left d-flex align-items-center"> <a href="shop-details-1.html"
                  ...
                  src="http://localhost:3000/src/assets/images/shop/products-img1.jpg" alt=""> </a>
            ...
            <div class="items d-flex justify-content-between align-items-center">
              <div class="left d-flex align-items-center"> <a href="shop-details-1.html"
                                                              class="thumb d-flex justify-content-between align-items-center"> <img
                  src="http://localhost:3000/src/assets/images/shop/products-img2.jpg" alt=""> </a>
                <div class="text"> <a href="shop-details-1.html">
            ...
            <div class="items d-flex justify-content-between align-items-center">
              <div class="left d-flex align-items-center"> <a href="shop-details-1.html"
                                                              class="thumb d-flex justify-content-between align-items-center"> <img
                  src="http://localhost:3000/src/assets/images/shop/products-img3.jpg" alt=""> </a>
                <div class="text"> <a href="shop-details-1.html">
                  <h6>Diamond Ring </h6>
                </a>
            ...
            <div class="items d-flex justify-content-between align-items-center">
              <div class="left d-flex align-items-center"> <a href="shop-details-2.html"
                                                              class="thumb d-flex justify-content-between align-items-center"> <img
                  src="http://localhost:3000/src/assets/images/shop/products-img4.jpg" alt=""> </a>
                <div class="text"> <a href="shop-details-1.html">
                  <h6>Women Earring</h6>
                </a>
                  <p>1 X <span>$150.00</span> </p>
              ...
              <div class="footer-default__single-box">
                ...
                <div class="footer-newsletter">
                  <p class="text">Enter your email to receive our latest updates about our products &
                    promotions. </p>
                  <form action="#" class="footer-default__subscrib-form">
        ...
        <div class="container">
          <div class="footer_bottom_content">
            ...
            <div class="footer-payment wow fadeInUp animated">
              <a href="#"> <img src="http://localhost:3000/src/assets/images/home-four/method-1.jpg" alt="payment"> </a>
              <a href="#"> <img src="http://localhost:3000/src/assets/images/home-four/method-2.jpg" alt="payment"> </a>
              <a href="#"> <img src="http://localhost:3000/src/assets/images/home-four/method-3.jpg" alt="payment"> </a>
              <a href="#"> <img src="http://localhost:3000/src/assets/images/home-four/method-4.jpg" alt="payment"> </a>
            </div>
          </div>
        </div>
      </div>
